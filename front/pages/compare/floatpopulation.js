...
const Floatpopulation = () => {
  ...
  const zones1 = ["황리단길 중심거리 1", "황리단길 중심거리 2", "황리단길 중심거리 3", "황리단길 북동", "황리단길 동남", "황리단길 동", "황리단길 서", "황리단길 서남"];
  const zones2 = ["불국사존", "석굴암존", "봉황대고분존", "황리단길 권역", "경주 터미널 온누리 약국 앞", "교촌마을존"];
  const zones3 = ["경주 대릉원", "동궁과월지존", "연꽃단지", "국립경주박물관", "첨성대존"];
  const zones4 = ["황리단길 중심거리 전체", "황리단길 북동 동남 동 전체", "황리단길 서 서남 전체", "동부사적지 권역", "불국사 권역", "경주 전체", "사적관리권역"];
  ...
  //zones4의 zoneid
  const zoneids4 = [2079, 2080, 2081, 2089, 2090, 2091, 2040];
  ...
  const arrY4_1 = ["신경주역", 0];
  const arrY4_2 = ["보문단지", 0];
  const arrY4_3 = ["동부해안가", 0];
  ...
  const getAPIdata = async () => {
    ...
    try {
      const responseVisit = await axios.get(`${process.env.NEXT_PUBLIC_API_GJ_URL}/DeviceCountDay?from=${sttdate}&to=${enddate}T09:00:00`);
      ...
      for (let i of responseVisit.data) {
        ...
        if (i.zone === zones1[0]) {
          ...
          arr4_1[1] = arr4_1[1] + Number(i.data);
          // 보문단지
        } else if (i.zone === zonesAll) {
          arr4_2[1] = arr4_2[1] + Number(i.data);
          // 동부해안가
        } else if (i.zone === zonesAll) {
          arr4_3[1] = arr4_3[1] + Number(i.data);
    ...
    try {
      const responseRevisit = await axios.get(`${process.env.NEXT_PUBLIC_API_GJ_URL}/DeviceCountRevisit?from=${sttdate}&to=${enddate}T09:00:00`);
    ...
    try {
      const responseStay = await axios.get(`${process.env.NEXT_PUBLIC_API_GJ_URL}/DeviceCountDay?from=${sttdate}&to=${enddate}T09:00:00`);
    ...
    try {
      const responseTime = await axios.get(`${process.env.NEXT_PUBLIC_API_GJ_URL}/DeviceResidenceTime?from=${sttdate}&to=${enddate}T09:00:00`);
  ...
  const searchStastic = () => {
    ...
    const getAPIStastics = async () => {
      try {
        const responseVisit = await axios.get(`${process.env.NEXT_PUBLIC_API_GJ_URL}/MonthStatistics?year=${selectYear}&month=${selectMonth}`);

        for (let i of responseVisit.data) {
          // i.gbname = "황리단길 통계청자료";
          excelStastics.push(i);
        }
        console.log(excelStastics);
        ...
        <div className="researchBox">
          ...
          {!loding ? (
            <div className="Sel_date">
              ...
              &nbsp;&nbsp;월&nbsp;
              <select className="form-control2" onChange={onClickMonth} value={selectMonth}>
              ...
              &nbsp;
              <button type="button " className="button" onClick={searchStastic}>
                {" "}
                검 색{" "}
              </button>
              <button type="button" className="button">
                <CSVLink
                  className="csv"
                  data={statisticseExcelData}
                  filename={"통계청제출자료-" + selectYear + "-" + selectMonth}
                  onClick={(event) => {
                    // console.log("You click the link");
                    // return false; // ???? You are stopping the handling of component
                  }}
          ...
          <Slider ref={slideEl} {...settings}>
            <div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_1} zoneName="중심거리1" zoneIndex="10" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_2} zoneName="중심거리2" zoneIndex="11" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_3} zoneName="중심거리3" zoneIndex="12" theme="light" />
              </div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_4} zoneName="북동거리" zoneIndex="13" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_5} zoneName="동남거리" zoneIndex="14" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_6} zoneName="동방거리" zoneIndex="15" theme="light" />
              </div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_7} zoneName="서방거리" zoneIndex="16" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo1_8} zoneName="서남거리" zoneIndex="17" theme="light" />
              </div>
            </div>
            <div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo2_1} zoneName="불국사" zoneIndex="1" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo2_2} zoneName="석굴암" zoneIndex="2" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo2_3} zoneName="봉황대고분" zoneIndex="3" theme="light" />
              </div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo2_4} zoneName="황리단길 권역" zoneIndex="4" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo2_5} zoneName="경주 터미널" zoneIndex="5" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo2_6} zoneName="교촌마을" zoneIndex="6" theme="light" />
              </div>
            </div>
            <div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo3_1} zoneName="경주 대릉원" zoneIndex="10" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo3_2} zoneName="동궁과월지" zoneIndex="11" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo3_3} zoneName="연꽃 단지" zoneIndex="12" theme="light" />
              </div>
              <div className="division">
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo3_4} zoneName="국립박물관" zoneIndex="13" theme="light" />
                <FloatPopulationInfo className="zonebox" zoneInfo={zoneInfo3_5} zoneName="첨성대" zoneIndex="14" theme="light" />
              </div>
            </div>
          </Slider>
        </div>
